    ...
    return (
        <section className="w-full bg-neutral-950 text-neutral-100 border-b border-gray-800">
            <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                    {actions.map(({ id, label, Icon }) => (
                        <button
                            ...
                            className="group inline-flex items-center gap-2 rounded-xl border border-neutral-800 bg-neutral-900/60 px-4 py-2 text-sm font-medium shadow-sm ring-1 ring-black/0 transition hover:border-neutral-700 hover:bg-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500"
                        >
                ...
                {/* Input card */}
                <div className="mt-6 rounded-2xl border border-neutral-800 bg-neutral-900/50 p-4 shadow-lg">
                    ...
                    <div className="flex items-start gap-3">
                        <button
                            ...
                            className="mt-1 rounded-lg border border-neutral-800 bg-neutral-900/70 p-2 transition hover:bg-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500"
                        >
                        ...
                        <div className="flex-1">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full resize-none rounded-xl border border-neutral-800 bg-neutral-950 px-4 py-3 pr-24 text-sm shadow-inner outline-none transition placeholder:text-neutral-500 focus:border-neutral-600 focus:ring-0"
                                />
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                    {suggestions.map((s, i) => (
                        <button
                            key={i}
                            onClick={() => setValue(s)}
                            className="inline-flex items-center gap-2 rounded-full border border-neutral-800 bg-neutral-900/50 px-4 py-2 text-xs sm:text-sm transition hover:border-neutral-700 hover:bg-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500"
                        >
