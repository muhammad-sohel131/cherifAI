    ...
    return (
        <div className="group relative rounded-2xl myborder bg-neutral-900 p-5 shadow-lg transition hover:shadow-xl hover:shadow-teal-900/20">
            ...
            <div className="mt-6">
                <button
                    onClick={() => onLaunch?.(id)}
                    className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-neutral-800 px-4 py-2 text-sm font-semibold brandColor ring-1 ring-inset ring-teal-700/50 transition hover:text-white hover:brandBg focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                >
