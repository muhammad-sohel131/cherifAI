            ...
            <div className="mx-auto max-w-6xl">
                ...
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    {badgeItems.map(({ id, title, desc, Icon }) => (
                        <div
                            key={id}
                            className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 text-center shadow-md ring-1 ring-inset ring-neutral-800"
                        >
                ...
                {/* Disclaimer */}
                <div className="mt-12 rounded-2xl border border-yellow-900/40 bg-gradient-to-b from-yellow-900/20 to-yellow-900/10 p-5 sm:p-6 ring-1 ring-inset ring-yellow-900/30">
