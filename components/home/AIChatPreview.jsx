    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-6 relative z-[2] text-center">
                ...
                <div className="relative flex flex-col items-stretch space-y-6 md:space-y-10 mx-auto">
                    {/* AI Bubble - Left */}
                    <motion.div
                        style={{ y: yBubbles }}
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 1 }}
                        className="self-start bg-[var(--primaryBlackforhover)] border border-[var(--borderColor)] rounded-2xl p-6 w-[85%] md:w-[60%] text-left shadow-[0_0_25px_rgba(0,229,255,0.15)]"
                    >
                    ...
                    <motion.div
                        ...
                        className="self-end bg-[var(--primaryBlackforhover)] border border-[var(--borderColor)] rounded-2xl p-6 w-[85%] md:w-[60%] text-left shadow-[0_0_25px_rgba(0,229,255,0.15)]"
                    >
                        <p className="text-gray-200">
                    ...
                    >
                        <p className="text-gray-200">
                            💬 <span className="text-[var(--brandColor)] font-semibold">Cherif AI:</span> Based on recent data, Downtown’s ROI trend is <span className="text-[var(--brandColor)] font-semibold">+7.2%</span> — projected to rise next quarter 📈.
                        </p>
                    </motion.div>
                </div>
